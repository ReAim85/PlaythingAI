...
export const useGeminiLive = () => {
  ...
  const startInterview = async (systemInstruction) => {
    ...
    try {
      ...
      console.log("Fresh token fetched:", token); // remove after confirming it works(not removing it, I can teach about ephimerel tokens with this log.)
